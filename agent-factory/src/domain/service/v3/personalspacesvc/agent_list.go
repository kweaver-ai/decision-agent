...
import (
	...
	"devops.aishu.cn/AISHUDevOps/DIP/_git/agent-factory/src/domain/p2e/personalspacep2e"
	...
	"devops.aishu.cn/AISHUDevOps/DIP/_git/agent-factory/src/driveradapter/api/rdto/personal_space/personalspaceresp"
