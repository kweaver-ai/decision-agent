module devops.aishu.cn/AISHUDevOps/DIP/_git/agent-app
...
require (
	devops.aishu.cn/AISHUDevOps/ONE-Architecture/_git/TelemetrySDK-Go.git/event/v2 v2.9.1 // indirect
	devops.aishu.cn/AISHUDevOps/ONE-Architecture/_git/TelemetrySDK-Go.git/exporter/v2 v2.9.1 // indirect
