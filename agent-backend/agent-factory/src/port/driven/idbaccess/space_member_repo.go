...
//go:generate mockgen -package idbaccessmock -destination ./idbaccessmock/space_member_repo.go github.com/kweaver-ai/decision-agent/agent-factory/src/port/driven/idbaccess ISpaceMemberRepo
