...
import (
	...
	"github.com/kweaver-ai/decision-agent/agent-factory/src/drivenadapter/httpaccess/ecoconfigaccess/ecoconfigdto"
...
func (svc *tempareaSvc) checkSource(ctx context.Context, req tempareareq.CreateReq, tempAreaID string) ([]tempareareq.TempArea,
	...
	maxSize, maxSizeUnit, types, maxFileCounts := agent.Config.Input.TempZoneConfig.SingleFileSizeLimit, agent.Config.Input.TempZoneConfig.SingleFileSizeLimitUnit, agent.Config.Input.TempZoneConfig.AllowedFileTypes, agent.Config.Input.TempZoneConfig.MaxFileCount
