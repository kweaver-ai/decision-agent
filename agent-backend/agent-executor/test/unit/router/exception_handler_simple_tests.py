...
class TestCodeExceptionHandler:
    ...
    async def test_handles_code_exception(self):
        ...
        with patch('app.router.exception_handler.code_handler.traceback.print_exc'):
            with patch('app.router.exception_handler.code_handler.log_oper.get_error_log'):
                with patch('app.router.exception_handler.code_handler.struct_logger.error'):
...
class TestPermissionExceptionHandler:
    ...
    async def test_handles_permission_exception(self):
        ...
        with patch('app.router.exception_handler.permission_handler.log_oper.get_error_log'):
...
class TestValidationHandler:
    ...
    async def test_handles_validation_error(self):
        ...
        with patch('app.router.exception_handler.validation_handler.struct_logger.error'):
    ...
    async def test_handles_unknown_error_type(self):
        ...
        with patch('app.router.exception_handler.validation_handler.struct_logger.error'):
            with patch('app.router.exception_handler.validation_handler.inspect.stack', return_value=[]):
                response = handle_param_error(request, exc)
