...
class TestGetAccountType:
    ...
    async def test_valid_new_header(self):
        ...
        account_type = await get_account_type(x_account_type="premium", x_user_type=None)
    ...
    async def test_valid_old_header(self):
        ...
        account_type = await get_account_type(x_account_type=None, x_user_type="standard")
    ...
    async def test_common_account_types(self):
        ...
        for account_type in types:
            result = await get_account_type(x_account_type=account_type, x_user_type=None)
    ...
    async def test_account_type_with_dashes_and_underscores(self):
        ...
        account_type = await get_account_type(
            x_account_type="premium-user_trial",
            x_user_type=None
        )
    ...
    async def test_case_sensitive_account_type(self):
        ...
        account_type1 = await get_account_type(x_account_type="Premium", x_user_type=None)
        account_type2 = await get_account_type(x_account_type="premium", x_user_type=None)
