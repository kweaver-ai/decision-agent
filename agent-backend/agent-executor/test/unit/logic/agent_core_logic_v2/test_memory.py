...
class TestMemoryHandler:
    ...
    @patch('app.logic.agent_core_logic_v2.memory.threading.Thread')
    @patch('app.logic.agent_core_logic_v2.memory.StandLogger')
    def test_start_memory_build_thread_none_memory(self, mock_logger, mock_thread_class):
    ...
    def test_build_memory_success(
        self, mock_get_type, mock_get_id, mock_logger, mock_memory_service,
        mock_set_loop, mock_new_loop, mock_thread_class
    ):
        """测试成功构建记忆"""
