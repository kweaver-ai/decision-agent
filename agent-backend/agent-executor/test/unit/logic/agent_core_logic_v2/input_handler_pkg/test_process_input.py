...
class TestProcessInput:
    ...
    async def test_process_input_with_string_field(self):
        ...
        with patch("app.logic.agent_core_logic_v2.input_handler_pkg.process_input.span_set_attrs") as mock_span_attrs, \
             patch("app.logic.agent_core_logic_v2.input_handler_pkg.process_input.get_user_account_id", return_value="user123"):
    ...
    async def test_process_input_with_string_field_empty(self):
        ...
        with patch("app.logic.agent_core_logic_v2.input_handler_pkg.process_input.span_set_attrs") as mock_span_attrs, \
             patch("app.logic.agent_core_logic_v2.input_handler_pkg.process_input.get_user_account_id", return_value=None):
    ...
    async def test_process_input_with_object_field_json(self):
        ...
        with patch("app.logic.agent_core_logic_v2.input_handler_pkg.process_input.span_set_attrs"), \
             patch("app.logic.agent_core_logic_v2.input_handler_pkg.process_input.get_user_account_id", return_value="user123"):
    ...
    async def test_process_input_with_is_debug(self):
        ...
        with patch("app.logic.agent_core_logic_v2.input_handler_pkg.process_input.span_set_attrs"), \
            ...
            result = await process_input(mock_agent_config, mock_agent_input, headers, is_debug=True)
    ...
    async def test_process_input_with_span(self):
        ...
        with patch("app.logic.agent_core_logic_v2.input_handler_pkg.process_input.span_set_attrs") as mock_span_attrs, \
            ...
            result = await process_input(mock_agent_config, mock_agent_input, headers, span=mock_span)
    ...
    async def test_process_input_multiple_fields(self):
        ...
        mock_agent_input = MagicMock()
        mock_agent_input.get_value = MagicMock(side_effect=lambda x: {
            "query": "test query",
            "params": '{"key": "value"}',
