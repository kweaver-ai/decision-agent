...
class TestDialogLogHandler:
    ...
    def test_save_to_single_file(self, mock_makedirs, mock_config_class):
        ...
        mock_config_class.dialog_logging.single_profile_file_path = "./data/debug_logs/profile.log"
        mock_config_class.dialog_logging.single_trajectory_file_path = "./data/debug_logs/trajectory.log"
    ...
    def test_save_to_multi_directories(self, mock_makedirs, mock_config_class):
        ...
        # Mock the save methods
        handler._save_trajectory_to_multi_directories = Mock(return_value="trajectory.jsonl")
    ...
    def test_save_trajectory_to_single_file(
        ...
        """测试保存trajectory到单一文件"""
        mock_config_class.dialog_logging.single_trajectory_file_path = "./data/debug_logs/trajectory.log"
        mock_datetime.datetime.now.return_value.strftime.return_value = "20250101_120000_000000"
    ...
    @patch('app.logic.agent_core_logic_v2.dialog_log.datetime')
    def test_save_profile_to_single_file(self, mock_datetime, mock_file, mock_config_class):
        """测试保存profile到单一文件"""
        mock_config_class.dialog_logging.single_profile_file_path = "./data/debug_logs/profile.log"
        mock_datetime.datetime.now.return_value.strftime.return_value = "20250101_120000_000000"
    ...
    @patch('app.logic.agent_core_logic_v2.dialog_log.os.makedirs')
    @patch('app.logic.agent_core_logic_v2.dialog_log.datetime')
    def test_save_trajectory_to_multi_directories(self, mock_datetime, mock_makedirs, mock_config_class):
        """测试保存trajectory到多目录"""
        mock_datetime.datetime.now.return_value.strftime.return_value = "20250101_120000_000000"
    ...
    @patch('builtins.open', new_callable=mock_open)
    @patch('app.logic.agent_core_logic_v2.dialog_log.datetime')
    def test_save_profile_to_multi_directories(self, mock_datetime, mock_file, mock_makedirs, mock_config_class):
        """测试保存profile到多目录"""
        mock_datetime.datetime.now.return_value.strftime.return_value = "20250101_120000_000000"
        self.mock_agent.get_profile.return_value = "Profile content"
    ...
    @patch('app.logic.agent_core_logic_v2.dialog_log.os.makedirs')
    @patch('app.logic.agent_core_logic_v2.dialog_log.datetime')
    def test_directory_creation_error(self, mock_datetime, mock_makedirs, mock_config_class):
        """测试目录创建错误"""
        mock_datetime.datetime.now.return_value.strftime.return_value = "20250101_120000_000000"
