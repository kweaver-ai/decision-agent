...
generic_template_strict = {
    ...
    "match with return": {
        ...
        # MATCH (v1:cust_order) WITH v1.cust_order.order_date.year AS
        # order_date,COUNT(v1.cust_order.order_date.year) AS count_order_date
        # ORDER BY count_order_date DESC LIMIT 1 RETURN order_date,
        # count_order_date
    },
    "match where return": {
        # 一个条件，返回属性值
